    ...
    if(isset($_POST['appointment_time'])) {
        ...
        // Convert appointment time to hours for validation
            ...
            if($time_hours < 8 || ($time_hours >= 21 && $time_minutes > 0) || $time_hours > 21) {
                ...
                $check_stmt = $conn->prepare("SELECT id FROM appointments WHERE appointment_date = ? AND appointment_time = ? AND status = 'confirmed'");
                ...
                if($result->num_rows > 0) {
                    ...
                    $error_message = "Sorry please select another slot";
                } else {
        ...
        <section class="section service" id="services" aria-label="services">
          <div class="container">
            ...
            <p class="section-text text-center">
              ...
              pain, and great effort, it must be suspended.ok
            </p>
            ...
            <div class="appoin-card">
              ...
              <div class="card-content">
                ...
                <form action="index.php" method="POST" class="appoin-form">
                  ...
                  <p class="time-info">Our working hours: 8:00 AM - 9:00 PM, Sunday to Friday. Salon is closed on Saturdays. Each appointment slot is allocated for one customer only.</p>
